...
/* harmony import */ var _modules_init_fixed_tabs_control__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/init-fixed-tabs-control */ "./js/modules/init-fixed-tabs-control.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_fixed_tabs_control__WEBPACK_IMPORTED_MODULE_14__["initFixedBlock"])();
    Object(_modules_init_fixed_tabs_control__WEBPACK_IMPORTED_MODULE_14__["initFixedServiceMenu"])();
...
/***/ "./js/modules/init-fixed-tabs-control.js":
/*!***********************************************!*\
  !*** ./js/modules/init-fixed-tabs-control.js ***!
  \***********************************************/
/*! exports provided: default, initFixedBlock, initFixedServiceMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FixedBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFixedBlock", function() { return initFixedBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFixedServiceMenu", function() { return initFixedServiceMenu; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var serviceNavMenu = document.querySelector('[data-service-menu]');

var FixedBlock = /*#__PURE__*/function () {
  function FixedBlock(element) {
  ...
  _createClass(FixedBlock, [{
    ...
    key: "_handlerFixedClass",
    value: function _handlerFixedClass() {
...
var initFixedBlock = function initFixedBlock() {
  if (!tabsControl) {
    return;
  }

  var fixedBlock = new FixedBlock(tabsControl);
  fixedBlock.init();
};

var initFixedServiceMenu = function initFixedServiceMenu() {
  if (!serviceNavMenu) {
    return;
  }

  var fixedServiceMenu = new FixedBlock(serviceNavMenu);
...
var ServiceNav = /*#__PURE__*/function () {
  function ServiceNav() {
    ...
    this._activeMenu = this._activeMenu.bind(this); // this._trackingScreenBlock = this._trackingScreenBlock.bind(this);
  }
  ...
  _createClass(ServiceNav, [{
    ...
    value: function _activeMenu() {
      ...
      this.button.addEventListener('click', function () {
        if (_this.root.classList.contains('is-active')) {
          _this.root.classList.remove('is-active');
        } else {
          _this.root.classList.add('is-active');
        }
      });
    }
  }, {
...
var initServiceNav = function initServiceNav() {
  var serviceNavMenu = new ServiceNav();
  serviceNavMenu.init();
};
