...
window.addEventListener('DOMContentLoaded', function () {
  ...
  initHeader();
  iniAnimate(); // initMoveTo();

  Object(_modules_init_move_to_service__WEBPACK_IMPORTED_MODULE_10__["initMoveToService"])();
  Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordions"])();
  Object(_modules_init_button_top_top__WEBPACK_IMPORTED_MODULE_15__["initButtonToTop"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var ServiceNav = /*#__PURE__*/function () {
  ...
  _createClass(ServiceNav, [{
    ...
    value: function _openMenu() {
      var serviceMenuCoord = this.root.getBoundingClientRect(); // this.scrollLock.disableScrolling();
