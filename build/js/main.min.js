...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordions"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var initMoveTo = function initMoveTo() {
  ...
  var triggers = document.querySelectorAll('[data-link-trigger]'); // const triggersWrapper = document.querySelector('.page-template__navigation');

  if (triggers) {
    for (var i = 0; i < triggers.length; i++) {
      moveTo.registerTrigger(triggers[i]); // triggers[i].addEventListener('click', () => {
