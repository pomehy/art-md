...
/* harmony import */ var _modules_sliders_init_partners_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/sliders/init-partners-slider */ "./js/modules/sliders/init-partners-slider.js");
/* harmony import */ var _modules_sliders_init_gratitudes_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/sliders/init-gratitudes-slider */ "./js/modules/sliders/init-gratitudes-slider.js");
/* harmony import */ var _modules_init_video__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-video */ "./js/modules/init-video.js");
/* harmony import */ var _modules_init_typed_text__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-typed-text */ "./js/modules/init-typed-text.js");
/* harmony import */ var _modules_init_move_to_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-move-to-service */ "./js/modules/init-move-to-service.js");
/* harmony import */ var _modules_init_articles_filter__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-articles-filter */ "./js/modules/init-articles-filter.js");
/* harmony import */ var _modules_init_header_control__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-header-control */ "./js/modules/init-header-control.js");
/* harmony import */ var _modules_init_animation__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-animation */ "./js/modules/init-animation.js");
/* harmony import */ var _modules_init_fixed_decor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/init-fixed-decor */ "./js/modules/init-fixed-decor.js");
/* harmony import */ var _modules_init_button_top_top__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/init-button-top-top */ "./js/modules/init-button-top-top.js");
/* harmony import */ var _modules_init_map__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/init-map */ "./js/modules/init-map.js");
/* harmony import */ var _modules_init_service_button_show__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/init-service-button-show */ "./js/modules/init-service-button-show.js");
/* harmony import */ var _modules_init_service_nav_menu__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/init-service-nav-menu */ "./js/modules/init-service-nav-menu.js");
/* harmony import */ var _modules_init_load_img__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/init-load-img */ "./js/modules/init-load-img.js");
/* harmony import */ var _modules_init_sort_date__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/init-sort-date */ "./js/modules/init-sort-date.js");
...
var initHeader = function initHeader() {
  var pageHeader = new _modules_init_header_control__WEBPACK_IMPORTED_MODULE_12__["default"]();
  pageHeader.init();
};

var iniAnimate = function iniAnimate() {
  var animate = new _modules_init_animation__WEBPACK_IMPORTED_MODULE_13__["default"]();
  animate.init();
}; //
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_video__WEBPACK_IMPORTED_MODULE_8__["initVideo"])(); // Modules
  // ---------------------------------

  Object(_modules_init_typed_text__WEBPACK_IMPORTED_MODULE_9__["initTypedText"])();
  initHeader();
  iniAnimate();
  Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordions"])();
  Object(_modules_init_button_top_top__WEBPACK_IMPORTED_MODULE_15__["initButtonToTop"])();
  Object(_modules_init_move_to_service__WEBPACK_IMPORTED_MODULE_10__["initMoveToService"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_sliders_init_gratitudes_slider__WEBPACK_IMPORTED_MODULE_7__["initGratitudesSlider"])();
    Object(_modules_sliders_init_partners_slider__WEBPACK_IMPORTED_MODULE_6__["initParntersSlider"])();
    Object(_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_5__["initTabs"])();
    Object(_modules_init_articles_filter__WEBPACK_IMPORTED_MODULE_11__["initArticlesFilter"])();
    Object(_modules_init_fixed_decor__WEBPACK_IMPORTED_MODULE_14__["initDecorBlock"])();
    Object(_modules_init_fixed_decor__WEBPACK_IMPORTED_MODULE_14__["initDecorServiceNav"])();
    Object(_modules_init_map__WEBPACK_IMPORTED_MODULE_16__["initMap"])();
    Object(_modules_init_service_button_show__WEBPACK_IMPORTED_MODULE_17__["initServiceButtonShow"])();
    Object(_modules_init_service_nav_menu__WEBPACK_IMPORTED_MODULE_18__["initServiceNav"])();
    Object(_modules_init_load_img__WEBPACK_IMPORTED_MODULE_19__["initLoadImg"])();
    Object(_modules_init_sort_date__WEBPACK_IMPORTED_MODULE_20__["getDateArr"])();
    Object(_modules_init_sort_date__WEBPACK_IMPORTED_MODULE_20__["handlerSort"])();
  });
}); // ---------------------------------
...
var Animation = /*#__PURE__*/function () {
  function Animation() {
    ...
    this.animationGroup = _toConsumableArray(document.querySelectorAll('[data-animation-group]'));
    this._getAnimatePoint = this._getAnimatePoint.bind(this);
    this._trackingScreenBlock = this._trackingScreenBlock.bind(this);
  }

  _createClass(Animation, [{
    key: "_getAnimatePoint",
    value: function _getAnimatePoint(group) {
      var elTop = group.getBoundingClientRect().top;
      var windowHeight = window.innerHeight;
      return windowHeight / 1.3 - elTop;
    }
  }, {
    key: "_trackingScreenBlock",
    value: function _trackingScreenBlock() {
      var _this = this;
      ...
      this.animationGroup.forEach(function (group) {
        var point = _this._getAnimatePoint(group);
...
/***/ "./js/modules/init-articles-filter.js":
/*!********************************************!*\
  !*** ./js/modules/init-articles-filter.js ***!
  \********************************************/
/*! exports provided: initArticlesFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initArticlesFilter", function() { return initArticlesFilter; });
var filterButtons = document.querySelectorAll('[data-filter="controls"] button');
var filterCards = document.querySelectorAll('[data-filter="parent"] .article-card');

var initArticlesFilter = function initArticlesFilter() {
  var getFilter = function getFilter(button, items) {
    items.forEach(function (item) {
      var curretCategory = button.dataset.filter;
      var isItemFiltered = item.dataset.filter;
  ...
  if (filterButtons) {
    filterButtons.forEach(function (button) {
      button.addEventListener('click', function () {
        var array = Array.from(filterButtons);
...
/***/ "./js/modules/init-button-top-top.js":
/*!*******************************************!*\
  !*** ./js/modules/init-button-top-top.js ***!
  \*******************************************/
/*! exports provided: initButtonToTop */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initButtonToTop", function() { return initButtonToTop; });
var buttonToTop = document.querySelector('[data-to-top]');

var handlerButtonToTop = function handlerButtonToTop() {
  if (!buttonToTop) {
    return;
  }
...
var initButtonToTop = function initButtonToTop() {
...
/***/ "./js/modules/init-fixed-decor.js":
/*!****************************************!*\
  !*** ./js/modules/init-fixed-decor.js ***!
  \****************************************/
/*! exports provided: default, initDecorBlock, initDecorServiceNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DecorBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDecorBlock", function() { return initDecorBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDecorServiceNav", function() { return initDecorServiceNav; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var tabsControl = document.querySelector('.tabs__controls');
var serviceNav = document.querySelector('[data-service-menu]');

var DecorBlock = /*#__PURE__*/function () {
  function DecorBlock(element) {
    _classCallCheck(this, DecorBlock);
  ...
  _createClass(DecorBlock, [{
    ...
    key: "_handlerClassDecor",
    value: function _handlerClassDecor() {
      var height = this._getHeight();

      var coordBlock = this._getCoord();
...
var initDecorBlock = function initDecorBlock() {
  if (!tabsControl) {
    return;
  }

  var decordBlock = new DecorBlock(tabsControl);
  decordBlock.init();
};

var initDecorServiceNav = function initDecorServiceNav() {
  if (!serviceNav) {
    return;
  }

  var decorServiceNav = new DecorBlock(serviceNav);
...
var HeaderNav = /*#__PURE__*/function () {
  ...
  _createClass(HeaderNav, [{
    ...
    key: "_handlerActiveClass",
    value: function _handlerActiveClass(item, scrollOff) {
    ...
    key: "_initActiveMenu",
    value: function _initActiveMenu() {
...
/***/ "./js/modules/init-load-img.js":
/*!*************************************!*\
  !*** ./js/modules/init-load-img.js ***!
  \*************************************/
/*! exports provided: initLoadImg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initLoadImg", function() { return initLoadImg; });
var imageLazyContainers = document.querySelectorAll('[data-image-lazy]');

var initLoadImg = function initLoadImg() {
  var getSrcImage = function getSrcImage(imageWrapper) {
    var imageElements = imageWrapper.querySelectorAll('img');
    var webpImagesElements = imageWrapper.querySelectorAll('source');
    ...
    for (var _k = 0; _k < webpImagesElements.length; _k++) {
      webpImagesElements[_k].srcset = webpImagesElements[_k].dataset.srcset;
    }
  };

  var uploadImages = function uploadImages(container) {
    var prevSection = container.previousElementSibling;

    if (prevSection) {
      window.addEventListener('scroll', function () {
        var coordPrevSection = prevSection.getBoundingClientRect();
  ...
  for (var j = 0; j < imageLazyContainers.length; j++) {
...
/*!********************************!*\
  !*** ./js/modules/init-map.js ***!
  \********************************/
/*! exports provided: addMap, initMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var breakpointSm = window.matchMedia('(max-width: 767px)');
var center = [55.39756706930534, 43.82468849999995];

var addMultitouch = function addMultitouch(map) {
  if (map) {
...
/***/ "./js/modules/init-move-to-service.js":
/*!********************************************!*\
  !*** ./js/modules/init-move-to-service.js ***!
  \********************************************/
/*! exports provided: initMoveToService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMoveToService", function() { return initMoveToService; });
...
var breakpointMD = window.matchMedia('(max-width:1023px)');
var breakpointSM = window.matchMedia('(max-width:767px)');
var breakpointS = window.matchMedia('(max-width:374px)');
var currentUrl = window.location.pathname;

var initMoveToService = function initMoveToService() {
  var getTolerance = function getTolerance() {
    var height;
  ...
  var moveToService = new _vendor_move_to__WEBPACK_IMPORTED_MODULE_0___default.a({
    tolerance: getTolerance(),
    duration: 600,
    easing: 'easeOutQuart',
    container: window
  });
  var triggers = document.querySelectorAll('[data-link-trigger]');
  ...
  triggers.forEach(function (trigger) {
    ...
    trigger.addEventListener('click', function () {
      var array = Array.from(triggers);
      var index = array.indexOf(trigger);
      array.forEach(function (item, i) {
        if (i === index) {
          item.classList.add('is-active');
        } else {
...
/***/ "./js/modules/init-service-button-show.js":
/*!************************************************!*\
  !*** ./js/modules/init-service-button-show.js ***!
  \************************************************/
/*! exports provided: initServiceButtonShow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initServiceButtonShow", function() { return initServiceButtonShow; });
var serviceItemContainers = document.querySelectorAll('[data-service-item-container]');

var initServiceButtonShow = function initServiceButtonShow() {
  ...
  var _loop = function _loop(i) {
    var audioItems = serviceItemContainers[i].querySelectorAll('[data-audio-item]');
    var buttonShow = serviceItemContainers[i].querySelector('[data-service-show-more]');
  ...
  for (var i = 0; i < serviceItemContainers.length; i++) {
    _loop(i);
  }
};
...
/***/ "./js/modules/init-service-nav-menu.js":
/*!*********************************************!*\
  !*** ./js/modules/init-service-nav-menu.js ***!
  \*********************************************/
/*! exports provided: default, initServiceNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ServiceNav; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initServiceNav", function() { return initServiceNav; });
/* harmony import */ var _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/scroll-lock */ "./js/utils/scroll-lock.js");
/* harmony import */ var _utils_ios_checker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/ios-checker */ "./js/utils/ios-checker.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ServiceNav = /*#__PURE__*/function () {
  function ServiceNav(element) {
    _classCallCheck(this, ServiceNav);
    ...
    this._iosChecker = _utils_ios_checker__WEBPACK_IMPORTED_MODULE_1__["iosChecker"];
    this._activeMenu = this._activeMenu.bind(this);
    this._handlerSubLinks = this._handlerSubLinks.bind(this);
  }

  _createClass(ServiceNav, [{
    key: "_openMenu",
    value: function _openMenu() {
      if (this._iosChecker()) {
        var serviceMenuCoord = this.root.getBoundingClientRect();
        this.root.classList.add('is-active');
        this.root.style.top = "".concat(serviceMenuCoord.top, "px");
      } else {
        var _serviceMenuCoord = this.root.getBoundingClientRect();

        this.scrollLock.disableScrolling();
        this.root.classList.add('is-active');
        this.root.style.top = "".concat(_serviceMenuCoord.top, "px");
      }
    }
  }, {
    key: "_closeMenu",
    ...
    key: "_handlerSubLinks",
    value: function _handlerSubLinks() {
      var _this = this;

      this.sublinks.forEach(function (sublink) {
...
var initServiceNav = function initServiceNav() {
  if (!serviceNav) {
    return;
  }

  var serviceNavMenu = new ServiceNav(serviceNav);
  serviceNavMenu.init();
...
/***/ "./js/modules/init-sort-date.js":
/*!**************************************!*\
  !*** ./js/modules/init-sort-date.js ***!
  \**************************************/
/*! exports provided: getDateArr, handlerSort */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDateArr", function() { return getDateArr; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handlerSort", function() { return handlerSort; });
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var articleCards = _toConsumableArray(document.querySelectorAll('[data-article-card="parent"]'));
...
var getDateArr = function getDateArr() {
  ...
  articleCards.forEach(function (card) {
    var date = card.querySelector('[data-article-card="date"]').dateTime.replace(/-/g, '/');
    dateArr.push(date);
  });
  ...
  var _loop = function _loop(i) {
    var dateCard = articleCards[i].querySelector('[data-article-card="date"]').dateTime.replace(/-/g, '/');
    sortDateArr.forEach(function (date, index) {
      if (date === dateCard) {
...
var sortingCard = function sortingCard(compare) {
...
var handlerSort = function handlerSort() {
  if (!sortButton) {
    return;
  }
...
/***/ "./js/modules/sliders/init-gratitudes-slider.js":
/*!******************************************************!*\
  !*** ./js/modules/sliders/init-gratitudes-slider.js ***!
  \******************************************************/
/*! exports provided: initGratitudesSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initGratitudesSlider", function() { return initGratitudesSlider; });
/* eslint-disable no-unused-vars */

/* eslint-disable no-undef */
var partnerSlider = document.querySelector('[data-slider-gratitudes]');
var swiper;
var prevButton;
var nextButton;
var pagination;
...
var initGratitudesSlider = function initGratitudesSlider() {
  if (!partnerSlider) {
    return;
  }
